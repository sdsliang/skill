...
> **④ 发布状态**：本轮又改了 4 个模板 + `input-contract.md` + **sys v0.15** ⇒ 本地 dist 重打为 **`a1b65809eb8b`（85,544 B / 19 entries / `mismatch vs worktree: []`）**，**prompt 与 skill 都需要再次授权**才能发（都是 in-place：prompt 仍 `v1.6`、skill 仍 `v1.0.7`）。
